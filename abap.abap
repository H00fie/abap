...
*SELECTION-SCREEN COMMENT 1(15) text-001. "Pula tekstów/informacji do u¿ytku w ekranach wyboru. Istnieje podobny mechanizm dla okienek z komunikatami, ale to co innego. NIE SZUKAÆ porównañ do Javy. To jest stricte ABAPikowa rzecz.
*
...
*  WRITE: 'Wartoæ zwrócona to: ', sy-subrc. "Wiêc wydrukuj mi wartoæ sy-subrc. Np. 4 mo¿e oznaczaæ b³¹d.
*ELSE.
*  WRITE: 'Podana liczba w s³owach to: ', result-word. "Jeli sy-subrc nie jest ró¿ne od 0 (a wiêc ma wartoæ 0 - czyli wszystko posz³o jak nale¿y), wtedy wydrukuj mi resultat.
...
*button in the Application Toolbar. In this example the name is 'Z7DPRJ'. In the pop-up window I need to provide the description
...
*----------THE TENTH STEP----------
*The 'Display Read Data' displays the data written into the LSMW Read file. I should Execute (F8) it, proceed without filling any of
*the input boxes (which amounts to a request to just read it all) and I should see all the data from the file neatly displayed in the screen.
...
*----------ADDITIONAL STEPS (FIXING ERRORS)----------
...
*to to check the structures listed here and find the fields I am interested in. 
*The TRAGR field can be found within the BMMH1 standard structure. I can create one transportation rule for all the records within the 
*file. I could, if I wanted to, add the necessary information to every record separately within the file. I prefer to create a rule though.
*I ought to select the field and click the 'Rule' button in the Application Toolbar. Here I make sure the 'Constant' option is selected 
*and proceed. Here I am to choose what value should be applied to all the transported records. In my case I am choosing the '0004' value. 
*I should save the progress now.
*In the same way I need to find the MATKL field. It is also located within the BMMH1 structure. Click the field, click the 'Rule' button,
...
*Both BDC and LSMW are used for data migration, but there are differences between them. These are:
...
*2. BDC is preferred for the customized applications while LSMW is preferred for the standard SAP applications.
*3. In case of BDC coding can be done flexibly while in case of LSMW the coding is restricted - I can code only as far as the conversion
*   rules allow me.
*4. BDC is a program either generated by SAP or programmed by the developer and LSMW is a tool.
*5. With BDC, the mapping needs to be done explicitly (manually). In case of LSMW, the mapping is taken care of by SAP herself.
*6. BDC is preferred when uploading large amounts of data so more than 5000 records. LSMW is recommended for smaller smaounts of data. It's
*   worth noting these are just good practices, I am not going to sacrificed at the altar of the Machine God for using LSMW for a set of
